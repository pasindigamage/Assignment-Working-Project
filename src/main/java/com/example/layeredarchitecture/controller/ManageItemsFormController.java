...
import static com.example.layeredarchitecture.controller.PlaceOrderFormController.itemDAO;
...
public class ManageItemsFormController {
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            itemDAO.btnDeleteOnAction(code);
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
                ...
                //Save Item
                itemDAO.btnSaveOnAction(code,description,unitPrice,qtyOnHand);
            ...
            try {
                ...
                /*Update Item*/
                itemDAO.btnUpdateOnAction(code,description,unitPrice,qtyOnHand);
    ...
    private String generateNewId() {
        try {
            ResultSet rst = itemDAO.genareteId();
